 ...
 * @author Luís
 */
class SignatureProdPlaceV2DataStructureVerifier implements PropertyDataObjectStructureVerifier
{
    @Override
    public void verifyStructure(PropertyDataObject propData) throws PropertyDataStructureException
    {
        SignatureProdPlaceV2Data sigProdPlaceData = (SignatureProdPlaceV2Data)propData;
        ...
        if (StringUtils.allNullOrEmptyStrings(
                ...
                sigProdPlaceData.getStreetAddress()))
