 ...
 * @author Luís
 */
class ToXmlSignerRoleV2Converter implements SignedPropertyDataToXmlConverter
{
    @Override
            ...
            Document doc)
    {
        ...
        XmlSignerRoleV2Type xmlSignerRole = new XmlSignerRoleV2Type();
        ...
        xmlProps.getSignedSignatureProperties().setSignerRoleV2(xmlSignerRole);
    }
}
