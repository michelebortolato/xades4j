...
public class XmlCertifiedRolesListTypeV2 {

    @XmlElement(name = "CertifiedRole", required = true)
    protected List<XmlCertifiedRoleTypeV2> certifiedRole;
     ...
     * {@link XmlCertifiedRoleTypeV2 }
     * 
     * 
     */
    public List<XmlCertifiedRoleTypeV2> getCertifiedRole() {
        if (certifiedRole == null) {
            certifiedRole = new ArrayList<XmlCertifiedRoleTypeV2>();
        }
